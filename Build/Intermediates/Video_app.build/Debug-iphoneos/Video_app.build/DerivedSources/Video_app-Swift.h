...
SWIFT_CLASS("_TtC9Video_app26CustomUICollectionViewCell")
...
SWIFT_CLASS("_TtC9Video_app21TopListViewController")
@interface TopListViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, strong) UICollectionView * _Null_unspecified myCollectionView;
- (void)viewDidLoad;
