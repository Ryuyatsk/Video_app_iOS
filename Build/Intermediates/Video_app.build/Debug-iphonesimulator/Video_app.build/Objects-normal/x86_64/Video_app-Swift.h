...
SWIFT_MODULE_NAMESPACE_PUSH("Video_app")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9Video_app11AppDelegate")
...
SWIFT_CLASS("_TtC9Video_app24CollectionViewController")
@interface CollectionViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull photos;
...
@property (nonatomic, strong) IBOutlet UITextView * _Null_unspecified descriptionField;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9Video_app32hogegogeCollectionViewController")
@interface hogegogeCollectionViewController : UICollectionViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
